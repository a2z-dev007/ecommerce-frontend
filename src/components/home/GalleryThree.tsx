...
const GalleryThree: React.FC = () => {
  ...
  const image1X = useTransform(scrollYProgress, [0.3, 0.5], [-120, -450]); // Desktop: Moves further LEFT
      ...
      <div className="sticky top-0 h-screen flex items-center justify-center overflow-hidden">
        <section className="w-full py-12 sm:py-16 md:py-32 px-4 sm:px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div
              className="relative flex items-center justify-center max-w-6xl mx-auto h-[280px] sm:h-[320px] md:h-[450px]"
