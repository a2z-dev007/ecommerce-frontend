...
const GalleryThree: React.FC = () => {
    ...
    const image1X = useTransform(scrollYProgress, [0.30, 0.5], [-120, -450]); // Desktop: Moves further LEFT
    const image1XMobile = useTransform(scrollYProgress, [0.30, 0.5], [-60, -180]); // Mobile: Less movement
    ...
    const image1RotateYMobile = useTransform(scrollYProgress, [0.05, 0.25, 0.4], [0, 0, 15]); // Mobile: Less tilt
    ...
    const image2X = useTransform(scrollYProgress, [0.3, 0.5, 0.65], [100, 0, -250]); // Desktop: Moves LEFT for image 3
    const image2XMobile = useTransform(scrollYProgress, [0.3, 0.5, 0.65], [50, 0, -100]); // Mobile: Less movement
    ...
    const image2RotateYMobile = useTransform(scrollYProgress, [0.3, 0.5, 0.65], [0, 10, 15]); // Mobile: Less tilt
    ...
    const image3RotateYMobile = useTransform(scrollYProgress, [0.55, 0.75], [8, 12]); // Mobile: Less tilt
    ...
    return (
        ...
        <div ref={containerRef} className="relative" style={{ height: '400vh' }}>
            ...
            <div className="sticky top-0 h-screen flex items-center justify-center overflow-hidden">
                <section className="w-full py-12 sm:py-16 md:py-32 px-4 sm:px-6">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="relative flex items-center justify-center max-w-6xl mx-auto h-[280px] sm:h-[320px] md:h-[450px]" style={{ perspective: '1500px' }}>
                            ...
                            <motion.div
                                ...
                                className="absolute left-1/2 -translate-x-1/2 w-[45%] sm:w-[40%] md:w-[500px] h-[65%] sm:h-[70%] md:h-[340px] rounded-xl sm:rounded-2xl md:rounded-3xl overflow-hidden shadow-[0_15px_40px_rgba(0,0,0,0.15)] md:shadow-[0_25px_70px_rgba(0,0,0,0.2)] z-10 cursor-pointer will-change-transform"
                            ...
                            <motion.div
                                ...
                                className="absolute left-1/2 -translate-x-1/2 w-[52%] sm:w-[48%] md:w-[520px] h-[75%] sm:h-[78%] md:h-[370px] rounded-xl sm:rounded-2xl md:rounded-3xl overflow-hidden shadow-[0_18px_50px_rgba(0,0,0,0.2)] md:shadow-[0_30px_80px_rgba(0,0,0,0.25)] z-20 cursor-pointer will-change-transform"
                            ...
                            <motion.div
                                ...
                                className="absolute left-1/2 -translate-x-1/2 w-[60%] sm:w-[55%] md:w-[540px] h-[85%] sm:h-[88%] md:h-[410px] rounded-xl sm:rounded-2xl md:rounded-3xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.25)] md:shadow-[0_35px_90px_rgba(0,0,0,0.3)] z-30 cursor-pointer will-change-transform"
