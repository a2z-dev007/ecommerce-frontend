          ...
          <div className="md:col-span-6 flex flex-col gap-4 sm:gap-5">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent p-6 sm:p-8 md:p-10 flex flex-col justify-end">
                <h3 className="text-white text-2xl sm:text-3xl md:text-[40px] font-bold mb-2 sm:mb-3 leading-tight">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
              ...
              >
                <div>
                  <h4 className="text-[36px] sm:text-[48px] md:text-[56px] font-black text-brand-brown leading-none">
                    98%
                  </h4>
          ...
          <div className="md:col-span-6 flex flex-col gap-4 sm:gap-5">
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-5 h-[200px] sm:h-[180px] md:h-[280px]">
              ...
              >
                <div className="mb-2 sm:mb-3 md:mb-4">
                  <h4 className="text-[28px] sm:text-[36px] md:text-[40px] font-bold text-brand-brown leading-none">
                    1.8 Kg
                  </h4>
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-6 sm:p-8 md:p-10 flex flex-col justify-end">
                <h3 className="text-white text-2xl sm:text-3xl md:text-[40px] font-bold leading-tight">
                  Confident Commuting
                </h3>
              </div>
            </motion.div>
