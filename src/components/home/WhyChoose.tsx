            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <motion.p
                        ...
                        viewport={{ once: false }}
                        className="light-text text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-5">
                    ...
                    <div className="md:col-span-6 flex flex-col gap-4 sm:gap-5">
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: false }}
                            className="relative rounded-[24px] sm:rounded-[32px] overflow-hidden group shadow-lg h-[250px] sm:h-[280px] md:h-[350px]"
                        >
                            <ParallaxImage
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                            ...
                            <motion.div
                                ...
                                viewport={{ once: false }}
                                className="bg-[#E5E2DA] rounded-[24px] sm:rounded-[32px] p-6 sm:p-6 md:p-8 flex flex-col justify-between h-[180px] sm:h-[180px] md:h-[200px] shadow-sm group"
                            >
                                <div>
                                    <h4 className="text-[36px] sm:text-[48px] md:text-[56px] font-black text-brand-brown leading-none">98%</h4>
                                    <p className="text-brand-brown/40 text-[9px] sm:text-[10px] md:text-[11px] font-bold uppercase tracking-widest mt-2">Satisfaction rate</p>
                                </div>
                                <div className="flex -space-x-2 sm:-space-x-3 mt-auto">
                                    {[1, 2, 3, 4, 5].map(i => (
                                        <img
                                            ...
                                            className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-full border-2 border-[#E5E2DA] shadow-sm group-hover:translate-y-[-4px] transition-transform"
                            ...
                            <motion.div
                                ...
                                whileInView={{ opacity: 1, x: 0 }}
                                viewport={{ once: false }}
                                className="bg-[#6B4A2D] rounded-[24px] sm:rounded-[32px] flex items-center justify-between shadow-lg relative overflow-hidden h-[180px] sm:h-[180px] md:h-[200px] group px-6 sm:px-4 md:px-6 py-4 sm:py-5"
                            >
                                {/* Text Section - Left Side */}
                                <div className="relative z-10 flex-shrink-0">
                                    <h4 className="text-white text-left text-[15px] sm:text-base md:text-[18px] lg:text-[20px] font-bold leading-tight ">
                                        Radiation<span className="block opacity-60 font-normal text-xs mt-1">Shield Protection</span>
                                    </h4>
                                </div>
                    ...
                    <div className="md:col-span-6 flex flex-col gap-4 sm:gap-5">
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: false }}
                            className="relative rounded-[24px] sm:rounded-[32px] overflow-hidden group shadow-lg h-[250px] sm:h-[180px] md:h-[270px]"
                        >
                            <ParallaxImage
