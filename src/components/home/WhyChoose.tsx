...
const WhyChoose: React.FC = () => {
  ...
  return (
    <section className="bg-[#F8F5F0] py-12 sm:py-16 md:py-24 xl:py-2 2xl:py-32 px-4 sm:px-6 relative overflow-hidden">
      {/* Background Blobs */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12 md:mb-16 xl:mb-4">
          ...
          <motion.h2
            ...
            viewport={{ once: false }}
            className="text-[clamp(2.5rem,7vw,5rem)] xl:text-[1.8rem] 2xl:text-[clamp(2.5rem,7vw,5rem)] leading-[1.1] mb-2 xl:mb-1 tracking-tight"
          >
          ...
          <motion.p
            ...
            viewport={{ once: false }}
            className="light-text text-sm md:text-base xl:text-xs max-w-2xl xl:max-w-md mx-auto leading-relaxed px-4 xl:mb-4"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-5 xl:gap-2">
          ...
          <div className="md:col-span-6 flex flex-col gap-4 sm:gap-5">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: false }}
              className="relative rounded-[24px] sm:rounded-[32px] overflow-hidden group shadow-lg h-[250px] sm:h-[280px] md:h-[350px] xl:h-[130px] 2xl:h-[350px]"
            >
              <ParallaxImage
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent p-6 sm:p-8 md:p-10 xl:p-5 2xl:p-10 flex flex-col justify-end">
                <h3 className="text-white text-2xl sm:text-3xl md:text-[40px] xl:text-base 2xl:text-[40px] font-bold mb-2 sm:mb-1 leading-tight">
                  Hands-Free Workstation
                </h3>
                <p className="text-white/70 text-xs sm:text-sm md:text-base max-w-xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
              ...
              <motion.div
                ...
                viewport={{ once: false }}
                className="bg-[#E5E2DA] rounded-[24px] sm:rounded-[32px] p-6 sm:p-6 md:p-8 xl:p-2 2xl:p-8 flex flex-col justify-between h-[180px] sm:h-[180px] md:h-[200px] xl:h-[75px] 2xl:h-[200px] shadow-sm group"
              >
                <div>
                  <h4 className="text-[36px] sm:text-[48px] md:text-[56px] xl:text-2xl 2xl:text-[56px] font-black text-brand-brown leading-none">
                    98%
                  </h4>
                ...
                <div className="flex -space-x-2 sm:-space-x-3 mt-auto">
                  {[1, 2, 3, 4, 5].map((i) => (
                    <img
                      ...
                      className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 xl:w-6 xl:h-6 rounded-full border-2 border-[#E5E2DA] shadow-sm group-hover:translate-y-[-4px] transition-transform"
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: false }}
                className="btn-premium rounded-[24px] sm:rounded-[32px] flex items-center justify-between shadow-lg relative overflow-hidden h-[180px] sm:h-[180px] md:h-[200px] xl:h-[75px] 2xl:h-[200px] group px-6 sm:px-4 md:px-6 py-4 sm:py-5 xl:px-4 xl:py-2 2xl:px-6 2xl:py-5 border-none"
              >
          ...
          <div className="md:col-span-6 flex flex-col gap-4 sm:gap-5">
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-5 h-[200px] sm:h-[180px] md:h-[280px] xl:h-[90px] 2xl:h-[280px]">
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-4 sm:p-6 md:p-8 xl:p-2 2xl:p-8 flex flex-col justify-end">
                  <h3 className="text-white text-lg sm:text-xl md:text-2xl xl:text-xs font-bold leading-tight">
                    Ergonomic Support
                  </h3>
                </div>
              </motion.div>
              ...
              >
                <div className="mb-2 sm:mb-3 md:mb-4">
                  <h4 className="text-[28px] sm:text-[36px] md:text-[40px] xl:text-[24px] font-bold text-brand-brown leading-none">
                    1.8 Kg
                  </h4>
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: false }}
              className="relative rounded-[24px] sm:rounded-[32px] overflow-hidden group shadow-lg h-[250px] sm:h-[180px] md:h-[270px] xl:h-[115px] 2xl:h-[270px]"
            >
              <ParallaxImage
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-6 sm:p-8 md:p-10 xl:p-5 2xl:p-10 flex flex-col justify-end">
                <h3 className="text-white text-2xl sm:text-3xl md:text-[40px] xl:text-base 2xl:text-[40px] font-bold leading-tight">
                  Confident Commuting
                </h3>
              </div>
            </motion.div>
