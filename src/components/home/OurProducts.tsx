...
const products = [
    {
        ...
        category: "Flagship",
        price: "$199.00",
        description: "The ultimate wearable workstation for the modern professional.",
            ...
            <div className="aspect-[4/5] relative overflow-hidden bg-brand-beige/20">
                <div className="absolute top-4 left-4 z-10 flex gap-2">
                    {product.tags.map((tag, i) => (
                        <span key={i} className="px-3 py-1 bg-white/90 backdrop-blur-sm text-[10px] font-bold uppercase tracking-wider text-brand-brown rounded-full">
                            {tag}
                        </span>
                    ))}
                </div>
...
const OurProducts: React.FC = () => {
    return (
        <section id="products" className="py-24 md:py-32 bg-brand-beige/30 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
                    <div className="max-w-2xl">
                        ...
                        >
                            Thoughtfully designed gear to elevate your workflow, wherever life takes you.
                        </motion.p>
                    </div>
