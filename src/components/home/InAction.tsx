...
const InAction: React.FC = () => {
    ...
    return (
        <section className="bg-brand-beige py-24 flex flex-col items-center">
            {/* Badge */}
            ...
            <h2 className="text-[clamp(2.5rem,7vw,5rem)] leading-[1.1] mb-4 tracking-tight text-center">
                <span className="text-[#6B4A2D] font-bold">In </span>
                <span className="text-[#B8AFA1] font-bold">Action.</span>
            </h2>

            {/* Description */}
            <p className="light-text text-sm md:text-base max-w-2xl mx-auto leading-relaxed text-center mb-16 px-6">
                See how Kangpack transforms any space into a hands-free mobile workspace.
            </p>

            <div className="w-full max-w-7xl px-4 md:px-12">
                <div
                    className="relative aspect-video rounded-[50px] overflow-hidden shadow-2xl group cursor-pointer"
                    onClick={() => openLightbox(["https://picsum.photos/seed/action_video/1920/1080"], 0)}
                >
                    <img src="https://picsum.photos/seed/action_video/1920/1080" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000" alt="In Action" />
